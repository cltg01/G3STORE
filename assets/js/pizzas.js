let pizzaJson = [
    ...
    {id:5, name:'Planner 2025', img:'./assets/imagens/planner2.jpeg', price:21.43, sizes:['P', 'D', 'C'], description:'Planners organizados e elegantes, perfeitos para planejar sua rotina, metas e compromissos com praticidade.'},
    {id:6, name:'Papelaria', img:'./assets/imagens/papelaria.png', price:18.55, sizes:['P', 'D', 'C'], description:'Produtos de papelaria lindos e funcionais, ideais para organização, estudos ou presentear com estilo.'},
    {id:7, name:'Biblia', img:'./assets/imagens/biblia3.png', price:22.36, sizes:['P', 'D', 'C'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'}
];
